...
package nodomain.freeyourgadget.gadgetbridge.service.devices.sn60plus.operation;
...
import nodomain.freeyourgadget.gadgetbridge.service.devices.sn60plus.Sn60PlusSupport;
import nodomain.freeyourgadget.gadgetbridge.util.GB;

public class FetchStepCountDataOperation extends AbstractBTLEOperation<Sn60PlusSupport>  {
    private static final Logger LOG = LoggerFactory.getLogger(FetchStepCountDataOperation.class);

    private final Sn60PlusSupport support;

    public FetchStepCountDataOperation(Sn60PlusSupport support) {
        super(support);
